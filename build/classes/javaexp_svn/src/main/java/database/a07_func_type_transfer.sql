 ...
 * */
 SELECT ename, hiredate,
 	...
 	to_char(hiredate,'CC"세기 " WW"째주" DAY ') "날짜표시2"
FROM emp;
...
-- ex2) emp01 사원번호와 사원명(김길동)으로 날짜(2020/12/31 23:59:59)
--      데이터를 입력하여 처리하세요.
INSERT INTO emp01(empno, ename, hiredate)
VALUES (7900,'홍길동',to_date('2020/12/31 23:59:59',
	'YYYY/MM/DD HH24:MI:SS'));
SELECT * FROM emp01;
-- ex3) emp01 사원번호, 부서번호, 사원명 날짜 2021-06-09 12:15:25 를 
--      입력하세요 
