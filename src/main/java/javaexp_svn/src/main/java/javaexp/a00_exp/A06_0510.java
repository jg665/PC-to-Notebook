...
public class A06_0510 {
	...
	public enum Cards{하트,스페이드,클로바,다이아몬드};	
...
/*    
4. enum 상수의 주요 속성을 기술하고, cards의 종류4가지
...
/*    
5. 객체형 배열의 생성 기본 형식을 기술하고,  Student객체에 
