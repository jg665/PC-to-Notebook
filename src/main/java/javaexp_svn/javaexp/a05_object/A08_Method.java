...
public class A08_Method {
	...
	public static void main(String[] args) {
		...
		// 배열이 리턴되니 배열에 해당하는 데이터 type으로 할당하여 사용
		int[] arr6 = ob1.returnExp6();
		System.out.println(arr6[0]);
		System.out.println(arr6[1]);
		System.out.println(arr6[2]);
		double dbl01 = ob1.returnExp4();
		System.out.println("실수를 리턴받아서 실수변수에 할당:"+dbl01);
		System.out.println(ob1.returnExp8());
...
class Object01{
	// 리턴할 유형선언 메서드명(){ return 리턴할 실제데이터; }
	String returnExp() {
		return "안녕하세요";
	}
