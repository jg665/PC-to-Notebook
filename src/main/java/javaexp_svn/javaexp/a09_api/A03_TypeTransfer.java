...
// 클래스명 누르고 왼쪽 위에 Refector > Rename > 수정 후 엔터를 통해서 클래스명 변경 가능!
...
//		System.out.println("총계: "+(fprice*fcnt)); => 에러 발생한다!
		// 이유 : 숫자형태의 데이터가 아니기 때문에 연산을 할 수 없다.
		// 숫자형문자열 ==> 숫자로 바꾸기 위해서는
