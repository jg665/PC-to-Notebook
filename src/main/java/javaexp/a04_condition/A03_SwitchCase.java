...
/*
# switch case문
1. 특정한 변수를 받아서, 해당 변수의 case를 지정하여,
	조건문을 처리하는 형식을 말한다.
2.	기본 형식
	switch(변수){
		case 변수유형1:
...
3. switch case문에서 break;
	1) 해당 case에 process를 중단처리하여, switch문의 {}
		블럭을 벗어 나게 한다.
...
// ex) 문제의 정답을 입력하세요(1~4) 3번인 경우만, 정답 그 이외에는 오답을
//		출력하는 switch case 문을 작정하세요. (1~4) 이외는 입력할 번호가
//		아닙니다. 출력(2조)
		/*
		...
		*/
		...
		System.out.println("투자금액 :" +input_mn);
		System.out.println("선택번호 :" +ranNum);

		switch(ranNum) {
		case 1:
		case 5:
		case 8:	
			System.out.println("당첨 금액:"+(input_mn*2.0));
			break;
		case 2:
		case 4:
		case 9:
			System.out.println("당첨 금액:"+(input_mn*3.0));
			break;
			default:
