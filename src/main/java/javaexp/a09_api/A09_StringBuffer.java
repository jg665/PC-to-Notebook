...
1. 문자열은 추가적으로 +=로 처리할 시, 해당 문자열의 같은
	...
	heap영역의 메모리를 만들어가기 때문에, 메모의 비효율과
	부하를 발생시킨다.
...
2. 문자열에 대한 하나의 메모리에 효과적인 추가 처리를 위해서 
	...
	2)	주요기능메서드..
		...
		.delete(시작index, 마지막index) : 해당 위치에 있는 데이터를 삭제처리
...
//	 최종 결과 출력..
		StringBuffer sbf1 = new StringBuffer("#과일 목록 입니다.#\n");
		sbf1.append("사과,바나나,딸기");
		System.out.println(sbf1.toString());
		sbf1.delete(17, 21);
		System.out.println(sbf1.toString());
		sbf1.replace(17,sbf1.length(),"오렌지");
		System.out.println(sbf1.toString());
