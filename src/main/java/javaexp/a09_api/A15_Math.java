...
//		진 숫자 : @@ (패) 위 함수 활용
		...
		if(dice1==dice2) {
			...
			System.out.println("이긴 숫자"+Math.min(dice1, dice2)+"(패)");
		}
...
//		경우의 수부터 생각하시고 /(나눗셈) 처리도 생각해보면 된다.
