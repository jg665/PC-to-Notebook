...
public class A03_TypeTransfer { //클래스 이름 바꿀때 refactor - rename
...
3. 숫자형 데이터를 문자열로 변환하여 처리..
	...
	2) 간략하게 ""+25 ==> "25"
		...
		String numStr="25";
		int num01 = 25;
		System.out.println(numStr+30); //2530
		System.out.println(Integer.parseInt(numStr)+30); //55
		// 문자열은 기본적으로 + 기호에 의해서 연결(contact)처리를 한다
		System.out.println(num01+30); //55
		String fname = args[0]; 
