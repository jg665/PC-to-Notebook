...
//	6) "문자열". sbustring(추출할시작위치 0, 추출할마지막위치)
...
//			.substring(0부터시작,1부터시작)
		...
		String sic = "901025-107512";
		System.out.println("주민번호"+sic);
		String subStr1 = sic.substring(0,6);
		String subStr2 = sic.substring(0,2);
		String subStr3 = sic.substring(2,4);
		String subStr4 = sic.substring(4,6);
		
		System.out.println("주민번호 :" +subStr1);
		System.out.println(subStr2+"년"+subStr3+"월"+subStr4+"일 생입니다.");
...
//	 ex) 서울-대구-대전-부산 나열된 문자열을 split 구분으로 통해서 처리하고
//		해당 내용을 for each 구문을 통해서 출력하세요.
