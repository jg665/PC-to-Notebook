 ...
 */
		...
		Father f = new Son(); // 하위 객체가 상위로 할당 promte
		// f.name (속성 접근이 불가능)
		Son s01 = (Son)f; // 상위 객체에 할당된 다시 하위 객체의 
