...
public class SearchDao {
	...
	public ArrayList<Lesson> schList(SearchSch sch){
		...
		String search =	sch.getKeyword();
		System.out.println(search);
		if(search.indexOf("자바")!=0) {
			System.out.println("검색어를 입력해 주세요.\n");
		}else {
			System.out.println("자바로 검색한 결과가 출력되었습니다");
		}
		
		System.out.println("강의명		\t	강사명	\t 별점 \t 가격");
		for(Lesson ser:list) {
...
/*
	...
	//		String search =	sch.getKeyword();
//		int idxLoc = search.indexOf(search);
//		System.out.println("검색키워드:" +idxLoc);
//		if(search.indexOf("자바")== 0) {
//			System.out.println("입력한 데이터가 출력되었습니다.");
//		}else {
//			System.out.println("다시 검색해 주십시오");
//		}
