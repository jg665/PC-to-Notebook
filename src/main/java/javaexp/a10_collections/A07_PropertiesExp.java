...
/*				영문자는 1byte범위 안에서 모든 문자를 표현할 수 있지만
...
//				OutputStream의 하위객체..
//				FileReader : 2byte 이상의 한글내용을 읽어 올 수 있는 객체
				Properties prop = new Properties();
				prop.load(fr);
				System.out.println("#저장된 회원 아이디 #");
				System.out.println("userid1:"+prop.getProperty("userid1"));
				System.out.println("userid2:"+prop.getProperty("userid2"));
				System.out.println("userid3:"+prop.getProperty("userid3"));
