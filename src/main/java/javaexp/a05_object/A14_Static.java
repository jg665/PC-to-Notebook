...
2. static을 선언된 멤버는 하나의 클래스에서 
	만들어진 모든 객체들의 데이터나 기능을 공유할 수 있다.
 	...
 	static 변수 선언하면 객체가 아무리 많아도 money2는 클래스 종속
 	공유하는 메모리
...
//		c1.money2=1000;
		...
		// static 변수나 메서드는 공유하는 영역이기 때문에 굳이 객체의 잠조변수로 
		// 쓰지 않고, 클래스명.static멤버로 사용한다.
...
//		ex) Bear name(이름)
//		일반변수:먹은 빵의 갯수 static변수로 전체 남은 빵의 갯수
//		1) 초기 전체 빵의 갯수를 할당.
		Bear.REST_BREAD=20;
...
//		2) 각자가 빵을 먹을때, 각자의 먹은 갯수 증가, static변수의 빵의 갯수 감소
//		3) 최종 각 곰돌이가 먹은 빵의 갯수와 남의 빵의 갯수를 출력..	
