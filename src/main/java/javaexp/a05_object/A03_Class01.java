...
public class A03_Class01 {
	...
	public static void main(String[] args) {
		...
		Person p01 = new Person(); //객체 생성되면 접근
		...
		System.out.println("p03의 name:" +p03.age);
		System.out.println("p03의 name:" +p03.loc);
		
		Person p04 = new Person();
		p04.name= "테스트";
		p04.age=18;
		p04.loc="서울";
		System.out.println("p04의 이름:"+p04.name);
		System.out.println("p04의 나이:"+p04.age);
		System.out.println("p04의 위치:"+p04.loc);
		...
		System.out.println("Product의 pro01:" +pro02.name);
		System.out.println("Product의 pro01:" +pro02.price);
		System.out.println("Product의 pro01:" +pro02.cnt);
		
		// ex) Product에 입력값이 있는 생성자를 추가하여, 초기값 처리하고,
