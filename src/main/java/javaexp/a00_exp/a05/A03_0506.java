...
//	만들어 진다
//	같은 도면으로 서울에서 건물을 지을 수 있고, 제주도에서 건물을 지을 수 있다.
//	그 안에 사용되는 데이터를 다를 수 있다.
		Movie m01 = new Movie();
		Movie m02 = new Movie();
 ...
 * 활용될 수 있지만, this는 전역필드를 지칭할때, 식별자로 사용되고 있다.*/
...
//6. Calculator 클래스를 선언하고, 생성자로 필드값을 할당하셔
...
//	private(클래스내부에서만), X(default패키지안에서), protected(상속관계의 다른패키지까지),
//	public(모두 접근가능)
		
//8. 추상클래스와 일반 클래스의 차이점을 기술하세요.
//		하위 상속하는 클래스의 재정의를 위한 클래스이다.
...
class RubberDuck extends Duck{
	...
	void flying() {
		// TODO Auto-generated method stub
		System.out.println("고무 오리는 날지 못한다.");
	}
}
class Mallard extends Duck{
	...
	void flying() {
		// TODO Auto-generated method stub
		System.out.println("청동 오리는 하늘을 훨훨 난다.");
	}
}
