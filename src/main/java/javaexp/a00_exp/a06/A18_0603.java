...
/*		
		...
		기본데이터 유형을 바로 할 때, autoboxing이 일어나서 객체로 Wrapper 된다.
		...
		2. 학생 5명의 이름과 국어, 영어, 수학 성적(0~100임의)으로 autoboxing으로 입력하고,
		    ...
		    */
			...
			// Math.random()*100 : 1~100 100가지,
    		// Math.random()*101 : 0~100 101가지
		    	System.out.println("번호\t이름\t국어\t영어\t수학\t총합");
...
//		    	sclist.add((int)(Math.random()*101));
//		    	System.out.println("이름\t성적\t점수");
//		    	System.out.print(slist.get(idx) + "\t");
//		    	System.out.print(blist.get(idx)+ "\t");
//		    	System.out.println(sclist.get(idx));
//		    }
		    /*
		...
		3. 임의의 범위를 1000.01 ~ 9999.99 로 설정하여
		    ...
		    */
		    ...
		    System.out.println("올림"+Math.ceil(ran)); // ceil 많이 쓰임.
		    System.out.println("내림"+Math.floor(ran));
		    System.out.println("반올림"+Math.round(ran));
		    
		    
//		    double ran = ((int)(Math.random()*10000)+0.01);
//		    System.out.println("랜덤수:"+ran);	
//		    System.out.println("올림"+Math.ceil(ran)); // ceil 많이 쓰임.
//		    System.out.println("내림"+Math.floor(ran));
//		    System.out.println("반올림"+Math.round(ran));
		...
		*/
		...
		5. Class 객체의 생성방법 2가지를 기술하세요.
			getClass() ex)Class clazz = obj.getClass();
			Class.forName("문자열클래스정보")
